...
namespace dag
{
    ...
    public:
        ...
        {
            addDynamicPort(new dagbase::Port(keyGen.nextPortID(), "angle", dagbase::PortDirection::DIR_IN, dagbase::Port::FLAGS_NONE, dagbase::Value(0.0)), dagbase::MetaPort::FLAGS_OWN_BIT);
            addDynamicPort(new dagbase::Port(keyGen.nextPortID(), "unit", dagbase::PortDirection::DIR_INTERNAL,  dagbase::Port::FLAGS_NONE, dagbase::Value(std::int64_t{0})), dagbase::MetaPort::FLAGS_OWN_BIT);
            addDynamicPort(new dagbase::Port(keyGen.nextPortID(), "output", dagbase::PortDirection::DIR_OUT, dagbase::Port::FLAGS_NONE, dagbase::Value(0.0)), dagbase::MetaPort::FLAGS_OWN_BIT);
        }
